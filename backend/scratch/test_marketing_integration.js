...
async function runTest() {
  console.log('🚀 Starting Phase 1: Cross-Divisional Data Integrity Test (JS version)');
  ...
  try {
    ...
    const testLead = await prisma.salesLead.create({
      data: {
        clientName: 'Test Marketing Client JS',
    ...
    const soId = `TEST-SO-JS-${Date.now()}`;
    ...
    console.log(`Final Revenue: ${finalAnalytics.acquisition.revenue}`);
    console.log(`Final Prospects: ${finalAnalytics.funnel.prospects}`);
