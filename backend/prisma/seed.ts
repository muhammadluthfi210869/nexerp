...
async function main() {
  ...
  const users = [
    ...
    { email: 'zarkasi@nexerp.id', fullName: 'Zarkasi', roles: [UserRole.MARKETING, UserRole.DIGIMAR] },
    { email: 'zarkasi@dreamlab.com', fullName: 'Zarkasi', roles: [UserRole.MARKETING, UserRole.DIGIMAR] },
    { email: 'gusti@nexerp.id', fullName: 'Gusti', roles: [UserRole.MARKETING, UserRole.DIGIMAR] },
    { email: 'gusti@dreamlab.com', fullName: 'Gusti', roles: [UserRole.MARKETING, UserRole.DIGIMAR] },
    { email: 'aurel@nexerp.id', fullName: 'Aurel', roles: [UserRole.MARKETING, UserRole.DIGIMAR] },
    { email: 'aurel@dreamlab.com', fullName: 'Aurel', roles: [UserRole.MARKETING, UserRole.DIGIMAR] },
    { email: 'edy@nexerp.id', fullName: 'Edy', roles: [UserRole.MARKETING, UserRole.DIGIMAR] },
    { email: 'edy@dreamlab.com', fullName: 'Edy', roles: [UserRole.MARKETING, UserRole.DIGIMAR] },
