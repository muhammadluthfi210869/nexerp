...
- **Path**: `C:\GAWE\Web Dev\Porto Aureon\ERP FROM ZERO\frontend\src\app\(dashboard)\marketing\reports\[brand]\[channel]\database\page.tsx`
- **Route**: `/marketing/reports/[brand]/[channel]/database`
