...
- **Path**: `C:\GAWE\Web Dev\Porto Aureon\ERP FROM ZERO\frontend\src\app\(dashboard)\penjualan\sales-orders\page.tsx`
- **Route**: `/penjualan/sales-orders`
...
- **Mock Arrays**: 1 (INITIAL_SALES_ORDERS)
- **React Query Hooks**: 0
- **Hardcoded `Rp`**: 0
...
**Mock State**: ⚠️ YES (INITIAL_SALES_ORDERS)
