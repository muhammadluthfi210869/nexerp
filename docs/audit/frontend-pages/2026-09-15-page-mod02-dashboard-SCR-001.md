...
- **Path**: `C:\GAWE\Web Dev\Porto Aureon\ERP FROM ZERO\frontend\src\app\(dashboard)\dashboard\page.tsx`
- **Route**: `/dashboard`
...
- **Total Lines**: 383
- **DNA Components**: 0
- **Raw UI Barrel Imports**: 2 (target: 0)
- **Mock Arrays**: 0 
- **React Query Hooks**: 2
- **Hardcoded `Rp`**: 0
- **Hardcoded `toLocaleString`**: 11
...
| 2 | FOLLOW UP AKTIVITAS 102 Task Selesai (0%) | yes | ✅ |
| 3 | JUMLAH MEETING 1 Offline & Online (Periode Ini) | yes | ✅ |
