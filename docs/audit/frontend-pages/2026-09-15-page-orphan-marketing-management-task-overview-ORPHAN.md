...
- **Path**: `C:\GAWE\Web Dev\Porto Aureon\ERP FROM ZERO\frontend\src\app\(dashboard)\marketing\management-task\overview\page.tsx`
- **Route**: `/marketing/management-task/overview`
