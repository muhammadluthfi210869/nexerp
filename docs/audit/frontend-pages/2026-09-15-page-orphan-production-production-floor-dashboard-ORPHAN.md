...
- **Path**: `C:\GAWE\Web Dev\Porto Aureon\ERP FROM ZERO\frontend\src\app\(dashboard)\production\production-floor-dashboard\page.tsx`
- **Route**: `/production/production-floor-dashboard`
- **Spec**: ❌ ORPHAN — no SCR mapping (orphan)
- **Match Method**: orphan
- **Total Lines**: 314
- **DNA Components**: 0
- **Raw UI Barrel Imports**: 6 (target: 0)
- **Mock Arrays**: 0 
- **React Query Hooks**: 6
- **Hardcoded `Rp`**: 0
