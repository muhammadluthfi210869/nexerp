...
- **Path**: `C:\GAWE\Web Dev\Porto Aureon\ERP FROM ZERO\frontend\src\app\(dashboard)\master\hr-attendance\page.tsx`
- **Route**: `/master/hr-attendance`
- **Spec**: ❌ ORPHAN — no SCR mapping (orphan)
- **Match Method**: orphan
- **Total Lines**: 313
- **DNA Components**: 9
- **Raw UI Barrel Imports**: 0 (target: 0)
- **Mock Arrays**: 1 (INITIAL_ATTENDANCE)
- **React Query Hooks**: 0
- **Hardcoded `Rp`**: 0
