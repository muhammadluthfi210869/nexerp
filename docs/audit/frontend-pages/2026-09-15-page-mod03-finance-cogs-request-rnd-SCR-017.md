...
- **Path**: `C:\GAWE\Web Dev\Porto Aureon\ERP FROM ZERO\frontend\src\app\(dashboard)\finance\cogs-request-rnd\page.tsx`
- **Route**: `/finance/cogs-request-rnd`
...
- **Mock Arrays**: 1 (MOCK_COGS_REQUESTS)
- **React Query Hooks**: 5
- **Hardcoded `Rp`**: 21
- **Hardcoded `toLocaleString`**: 22
...
**Mock State**: ⚠️ YES (MOCK_COGS_REQUESTS)
