...
- **Path**: `C:\GAWE\Web Dev\Porto Aureon\ERP FROM ZERO\frontend\src\app\(dashboard)\inventory\formula-adjustment-production\page.tsx`
- **Route**: `/inventory/formula-adjustment-production`
