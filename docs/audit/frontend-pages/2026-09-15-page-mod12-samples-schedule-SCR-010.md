...
- **Path**: `C:\GAWE\Web Dev\Porto Aureon\ERP FROM ZERO\frontend\src\app\(dashboard)\samples\schedule\page.tsx`
- **Route**: `/samples/schedule`
...
**Mock State**: ⚠️ YES (MOCK_SCHEDULES)
