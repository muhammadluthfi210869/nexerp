...
- **Path**: `C:\GAWE\Web Dev\Porto Aureon\ERP FROM ZERO\frontend\src\app\(dashboard)\master\kpi-department\[departmentId]\page.tsx`
- **Route**: `/master/kpi-department/[departmentId]`
