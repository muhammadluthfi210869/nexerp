...
import { SectionCard as Card } from "@/components/canonical";
import { StatusBadge as Badge } from "@/components/canonical";

const ProblemCard = ({ title, icon: Icon, color, issues }: { title: string, icon: any, color: string, issues: any[] }) => (
 <Card className="rounded-2xl p-5 border border-slate-100 bg-white flex flex-col h-full shadow-sm hover: transition-all">
...
export default function NotificationHubClient() {
 ...
 {/* 1. DIAGNOSTIC HEADER */}
 <div className="bg-white border border-gray-200 rounded-xl p-4 flex items-center justify-between shrink-0 shadow-slate-200">
 <div className="flex items-center gap-4">
 <div className="w-10 h-10 bg-rose-600 rounded-xl flex items-center justify-center text-white shadow-rose-500/20">
