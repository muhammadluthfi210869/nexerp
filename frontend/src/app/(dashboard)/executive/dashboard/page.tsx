...
export default function ExecutiveDashboardPage() {
 ...
 <button className="h-10 px-4 bg-[#0F172A] hover:bg-slate-800 text-white font-bold text-[10px] uppercase rounded-xl tracking-wider transition-all flex items-center gap-2 cursor-pointer border-none font-black">
 ...
 <div className="w-16 h-16 rounded-2xl overflow-hidden ring-4 ring-white animate-pulse">
