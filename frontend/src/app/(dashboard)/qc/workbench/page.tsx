...
export default function QCWorkbenchPage() {
 ...
 variant="primary"
 className={cn(
 "flex-[2] h-16 rounded-2xl text-sm tracking-widest",
 hasAllPass
 ...
 <DialogContent className="sm:max-w-[480px] bg-white rounded-2xl p-0 overflow-hidden border-none">
 ...
 className="flex-1 h-12 rounded-xl bg-amber-500 hover:bg-amber-600 text-white shadow-amber-200"
 >
