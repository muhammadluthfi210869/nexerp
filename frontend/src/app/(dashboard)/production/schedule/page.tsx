                      ...
                      schs.map((s: any) => {
                        ...
                        return (
                          <button
                            ...
                            className={cn(
                              "absolute top-2 h-12 rounded-lg px-2 py-1 border text-left transition-all hover:shadow-md hover:-translate-y-0.5 overflow-hidden",
                              color,
    ...
    >
      <Tabs defaultValue="gantt">
        <TabsList className="h-12 bg-slate-100 rounded-2xl p-1 grid grid-cols-2 max-w-[320px] border border-slate-200">
          <TabsTrigger value="gantt" className="h-full rounded-xl data-[state=active]:bg-white data-[state=active]:shadow-md font-black uppercase tracking-tight text-[10px]">Gantt</TabsTrigger>
          <TabsTrigger value="jadwal" className="h-full rounded-xl data-[state=active]:bg-white data-[state=active]:shadow-md font-black uppercase tracking-tight text-[10px]">Jadwal</TabsTrigger>
        </TabsList>
