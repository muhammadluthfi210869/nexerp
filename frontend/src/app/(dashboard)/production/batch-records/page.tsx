        ...
        {selectedBatch && (
          <>
            ...
            <motion.div
              ...
              className="fixed top-0 right-0 z-50 h-screen w-full lg:w-2/3 bg-white shadow-2xl flex flex-col border-l border-slate-100"
            >
              {/* Drawer Header */}
              <div className="p-6 border-b border-slate-100 flex justify-between items-center bg-slate-900 text-white overflow-hidden relative">
                 <div className="relative z-10 space-y-1.5">
                    <div className="flex items-center gap-3">
                       ...
                       <DnaBadge status={getStatus(selectedBatch.status)} className="shadow-lg shadow-black/20 py-0.5 px-2 rounded-md">
              ...
              <div className="flex-1 overflow-y-auto p-6 bg-slate-50/30">
                <Tabs defaultValue="info" className="w-full space-y-6">
                  <TabsList className="bg-slate-150 p-1.5 rounded-2xl h-14 border border-slate-200">
                    <TabsTrigger value="info" className="rounded-xl px-8 h-full data-[state=active]:bg-white data-[state=active]:shadow-md data-[state=active]:text-slate-900 font-black uppercase text-[10px] tracking-widest transition-all">
                       <ClipboardList className="mr-2 h-4 w-4" /> Batch Info
                    </TabsTrigger>
                    <TabsTrigger value="progress" className="rounded-xl px-8 h-full data-[state=active]:bg-white data-[state=active]:shadow-md data-[state=active]:text-slate-900 font-black uppercase text-[10px] tracking-widest transition-all">
                       <Activity className="mr-2 h-4 w-4" /> Stage Progress
                    </TabsTrigger>
                    <TabsTrigger value="materials" className="rounded-xl px-8 h-full data-[state=active]:bg-white data-[state=active]:shadow-md data-[state=active]:text-slate-900 font-black uppercase text-[10px] tracking-widest transition-all">
