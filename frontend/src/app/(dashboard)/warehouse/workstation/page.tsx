    ...
    <DashboardShell
      ...
      actions={
        <div className="flex items-center gap-3">
           ...
           <Button onClick={() => setIsTransferModalOpen(true)} className="h-12 px-8 bg-blue-600 hover:bg-blue-700 text-white font-black text-[10px] uppercase tracking-widest italic rounded-xl shadow-lg shadow-blue-100 border-none">
               ...
               <div className="space-y-6">
                  ...
                  <div className="p-8 bg-brand-black rounded-[24px] text-white space-y-8 relative overflow-hidden group shadow-2xl">
                     <div className="absolute top-0 right-0 p-6">
                        <DnaBadge status="success" className="bg-emerald-500 text-brand-black border-none font-black text-[9px] uppercase tracking-widest px-4 py-1.5 rounded-xl shadow-lg shadow-emerald-500/20">BEST MATCH</DnaBadge>
                     </div>
