...
export default function WarehouseWorkstation() {
 ...
 <Button variant="outline" onClick={() => setIsOpnameModalOpen(true)} className="h-12 px-6 border-amber-200 bg-white text-amber-600 font-black text-[10px] uppercase tracking-widest italic rounded-xl">
 <ClipboardCheck className="mr-2 h-4 w-4" /> STOCK OPNAME
 </Button>
 <Button onClick={() => setIsTransferModalOpen(true)} className="h-12 px-8 bg-blue-600 hover:bg-blue-700 text-white font-black text-[10px] uppercase tracking-widest italic rounded-xl shadow-blue-100 border-none">
 ...
 <TabsTrigger value="procurement" className="h-11 px-8 rounded-xl font-black text-[10px] uppercase tracking-widest italic flex gap-2 data-[state=active]:bg-slate-900 data-[state=active]:text-white data-[state=active]: transition-all">
 <Truck className="w-4 h-4" /> 01. PROCUREMENT
 </TabsTrigger>
 <TabsTrigger value="internal" className="h-11 px-8 rounded-xl font-black text-[10px] uppercase tracking-widest italic flex gap-2 data-[state=active]:bg-slate-900 data-[state=active]:text-white data-[state=active]: transition-all">
 <ArrowRightLeft className="w-4 h-4" /> 02. INTERNAL
 </TabsTrigger>
 <TabsTrigger value="logistics" className="h-11 px-8 rounded-xl font-black text-[10px] uppercase tracking-widest italic flex gap-2 data-[state=active]:bg-slate-900 data-[state=active]:text-white data-[state=active]: transition-all">
 ...
 <DnaBadge status="success" className="font-black text-[9px] uppercase tracking-widest px-4 py-1.5 rounded-xl shadow-sm italic">READY_FOR_HANDOVER</DnaBadge>
 <Button 
 onClick={() => setSelectedIssueItem(item)}
 className="h-12 px-8 bg-slate-900 hover:bg-emerald-600 text-white font-black uppercase tracking-widest text-[10px] rounded-xl shadow-slate-100 italic border-none transition-all"
 >
 ISSUE MATERIAL
 </Button>
 </div>
 ...
 <DialogContent className="sm:max-w-[550px] bg-white rounded-[24px] border border-slate-200 p-0 overflow-hidden">
 ...
 <div className="p-8 bg-slate-900 rounded-[24px] text-white space-y-8 relative overflow-hidden group">
 <div className="absolute top-0 right-0 p-6">
 <DnaBadge status="success" className="bg-emerald-500 text-brand-black border-none font-black text-[9px] uppercase tracking-widest px-4 py-1.5 rounded-xl shadow-emerald-500/20">BEST MATCH</DnaBadge>
 </div>
 ...
 className="flex-1 h-14 bg-emerald-600 hover:bg-emerald-700 text-white font-black uppercase tracking-widest text-xs rounded-2xl shadow-emerald-100 italic border-none transition-all"
 >
 CONFIRM & ISSUE BATCH
 </Button>
 </DialogFooter>
 ...
 <DialogContent className="sm:max-w-[500px] bg-white rounded-[24px] border border-slate-200 p-0 overflow-hidden">
 ...
 className="flex-1 h-16 bg-blue-600 hover:bg-blue-700 text-white font-black uppercase tracking-widest text-xs rounded-2xl shadow-blue-100 italic border-none transition-all"
 >
 ...
 <DialogContent className="sm:max-w-[700px] bg-white rounded-3xl border border-slate-200 p-0 overflow-hidden">
 <div className="bg-slate-900 p-10 text-white relative">
 ...
 className="w-full h-16 bg-slate-900 hover:bg-slate-800 text-white font-black uppercase tracking-widest rounded-2xl italic"
 ...
 <DialogContent className="sm:max-w-[600px] bg-white rounded-3xl border border-slate-200 p-0 overflow-hidden">
 <div className="bg-slate-900 p-10 text-white relative">
 ...
 }} className="h-14 w-14 bg-slate-900 text-white rounded-xl border-none hover:bg-slate-800"><Plus /></Button>
 </div>
 ...
 className="w-full h-16 bg-blue-600 hover:bg-blue-700 text-white font-black uppercase tracking-widest rounded-2xl italic border-none"
...
function WorkCard({
 ...
 status === 'PENDING' || status === 'DRAFT' || status === 'IN_TRANSIT' ? "warning" : "default"
 }
 className="border-none font-black text-[9px] uppercase tracking-widest px-4 py-1.5 rounded-xl shadow-sm italic"
 >{status}</DnaBadge>
 <Button 
 onClick={onAction}
 disabled={disabled}
 className={cn(
 "h-12 px-8 font-black uppercase tracking-widest text-[10px] rounded-xl italic border-none transition-all",
 isAmber ? "bg-amber-500 hover:bg-amber-600 text-white" : "bg-slate-900 hover:bg-slate-800 text-white"
 )}
 >
 {actionLabel}
 </Button>
