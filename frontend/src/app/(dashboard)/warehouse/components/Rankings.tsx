            ...
            <table className="w-full text-left">
              <thead>
                <tr className="bg-slate-50/50 border-b border-slate-100">
                  ...
                  <th className="px-6 py-4 text-table-header text-slate-400 text-center">PAKAI</th>
                  <th className="px-6 py-4 text-table-header text-slate-400 text-right">VALUE AUDIT</th>
                </tr>
              </thead>
