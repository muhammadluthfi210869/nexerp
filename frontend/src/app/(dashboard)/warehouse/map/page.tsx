...
export default function WarehouseMapPage() {
 ...
 <Button className="rounded-2xl bg-white text-slate-900 font-black uppercase text-[10px] h-11 tracking-tight px-6 shadow-slate-200 border border-slate-200">
 EDIT LAYOUT
 </Button>
 </div>
 }
 ...
 <DataCard className="shadow-slate-200/50" title="Zone Overview">
 <div className="space-y-2">
 {zones.map(z => (
 <div key={z.name} className="p-4 rounded-2xl bg-slate-50 border border-slate-100 flex items-center justify-between group cursor-pointer hover:bg-white hover: transition-all">
 <div className="flex items-center gap-3">
 ...
 <DataCard className="shadow-slate-200/50">
 ...
 <span className="text-sm font-black text-slate-900">24.2 °C</span>
 </div>
 <div className="flex items-center justify-between">
