  ...
  return (
      ...
      filters={
        <div className="relative group w-full lg:w-[400px]">
            <DnaInput 
              ...
              className="h-14 w-full bg-slate-50 border-slate-100 rounded-xl font-black text-[10px] uppercase tracking-widest italic"
              value={search}
    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
         <StatCard label="READY TO SHIP" value={orders.length.toString()} icon={<PackageCheck />} />
         <StatCard label="TRANSIT INBOUND" value="24" icon={<Truck />} />
         <StatCard label="VERIFIED (MTD)" value="142" icon={<CheckCircle2 />} />
      </div>
      ...
      <div className="space-y-4">
        ...
        {loading ? (
          <div className="py-24 text-center bg-white rounded-[24px] border border-slate-100">
              ...
              <Card key={order.id} className="bento-card overflow-hidden bg-white group hover:translate-y-[-5px] transition-all">
                ...
                <div className="p-8 space-y-8">
                   ...
                   <DnaButton 
                     variant="secondary"
                     size="lg"
                     className="w-full rounded-2xl shadow-xl shadow-slate-100 italic"
                     onClick={() => {
        ...
        {!loading && filteredOrders.length === 0 && (
          <div className="text-center py-24 bg-slate-50 rounded-[24px] border-2 border-dashed border-slate-200">
        ...
        <DialogContent className="sm:max-w-[600px] bg-white rounded-3xl border border-slate-200 shadow-2xl p-0 overflow-hidden">
          ...
          <div className="p-10 space-y-8">
            ...
            <div className="flex gap-4 pt-6 border-t border-slate-100">
                <DnaButton variant="ghost" size="lg" onClick={() => setIsModalOpen(false)}>CANCEL</DnaButton>
                <DnaButton 
                 variant="primary"
                 size="lg"
