...
export default function FleetControlCenter() {
  ...
  return (
    <DashboardShell
      ...
      subtitle="LIVE ASSET TRACKING & DISPATCH PROTOCOLS"
      actions={
        <div className="flex items-center gap-3">
           ...
           <div className="flex gap-2">
               <DnaButton variant="outline" size="lg" className="italic" icon={<Calendar />}>
                  SCHEDULE
               </DnaButton>
               <DnaButton variant="secondary" size="lg" className="italic shadow-xl shadow-slate-100" icon={<PlusCircle />}>
                  NEW SHIPMENT
               </DnaButton>
           </div>
        </div>
    ...
    >
      ...
      <Card className="bento-card bg-brand-black h-[500px] relative overflow-hidden group">
         ...
         <div className="absolute bottom-8 right-8 flex flex-col gap-3">
            <DnaButton variant="primary" size="lg" className="h-14 w-14 bg-white/5 backdrop-blur-md border border-white/10 text-white rounded-xl hover:bg-orange-500" icon={<Maximize2 />} />
            <DnaButton variant="primary" size="lg" className="h-14 w-14 bg-white/5 backdrop-blur-md border border-white/10 text-white rounded-xl hover:bg-orange-500" icon={<Radar />} />
         </div>

         <div className="absolute top-8 left-8">
            <DnaBadge status="success" className="rounded-full px-6 py-2.5 flex items-center gap-3 italic">
