    ...
    <div className="w-full font-sans">
      ...
      <section className="px-6 md:px-12 pt-8 pb-4 max-w-7xl mx-auto w-full">
        ...
        <div className="mb-6">
          ...
          <p className="text-[#787774] dark:text-[#909090] text-sm mt-1.5 flex items-center gap-2">
            <span className="inline-block w-2 h-2 rounded-full bg-emerald-500 animate-pulse" />
            <span>Mode Manual & Creative Planner Aktif. Kelola brief kreatif, jadwal editorial, dan metrik konten secara mandiri.</span>
          </p>
        </div>
