          ...
          <div className="p-6 md:p-8 space-y-6">
            ...
            {activeTab === 'editor' && (
              <div className="space-y-6">
                ...
                {/* Creative Brief & Content Angle */}
                <div className="p-4 bg-amber-50/70 dark:bg-amber-950/20 border border-amber-200/80 dark:border-amber-800/40 rounded-xl space-y-2">
                  <div className="flex items-center justify-between">
                    <h4 className="text-xs font-bold text-amber-900 dark:text-amber-300 uppercase tracking-wider flex items-center gap-1.5">
                      <span>🎯 Creative Brief & Visual Direction</span>
                    </h4>
                    <span className="text-[10px] font-medium px-2 py-0.5 bg-amber-100 dark:bg-amber-900/50 rounded text-amber-800 dark:text-amber-200">
                      Instruksi Produksi
                    </span>
                  </div>
                  <textarea
                    ...
                    placeholder="Tuliskan Creative Brief di sini: angle pembahasan, referensi shot visual, poin edukasi utama, atau USP produk yang harus ditonjolkan..."
                    className="w-full p-2.5 text-xs bg-white dark:bg-zinc-800 border border-amber-200 dark:border-zinc-700 rounded-lg outline-none focus:border-amber-500 text-[#37352f] dark:text-zinc-200 placeholder-zinc-400 font-sans leading-relaxed resize-y"
                  />
                </div>
