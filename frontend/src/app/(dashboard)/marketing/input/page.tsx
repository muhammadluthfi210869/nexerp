                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                   ...
                   <div className="bg-blue-600 rounded-2xl p-6 text-white flex flex-col justify-between relative shadow-xl">
                      ...
                      <div className="space-y-8">
                       ...
                       <DnaButton variant="outline" disabled={loading || !canEditTargets} onClick={submitTargets} className="w-full mt-8 text-blue-600 border-blue-200 hover:bg-blue-50 shadow-lg shadow-blue-900/40">
                         Commit Targets
                      </DnaButton>
                   </div>
                </div>
