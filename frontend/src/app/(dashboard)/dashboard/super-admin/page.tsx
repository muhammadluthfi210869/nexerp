...
export default function SuperAdminTerminal() {
  ...
  return (
    ...
    >
      ...
      <DnaTabs defaultValue="marketing" className="w-full space-y-8">
        <div className="sticky top-0 z-30 bg-white/80 backdrop-blur-xl py-4 -mx-4 px-4 border-b border-gray-200">
          <DnaTabsList className="bg-gray-50 border border-gray-200 p-1 rounded-xl w-full flex overflow-x-auto scrollbar-hide">
            <DnaTabsTrigger value="marketing" className="flex-1 data-[state=active]:bg-white data-[state=active]:text-black text-[10px] font-black uppercase tracking-tight h-10 italic">
              <Users className="w-3 h-3 mr-2" /> Commercial
            </DnaTabsTrigger>
            <DnaTabsTrigger value="rnd" className="flex-1 data-[state=active]:bg-white data-[state=active]:text-black text-[10px] font-black uppercase tracking-tight h-10 italic">
              <FlaskConical className="w-3 h-3 mr-2" /> R&D Lab
            </DnaTabsTrigger>
            <DnaTabsTrigger value="production" className="flex-1 data-[state=active]:bg-white data-[state=active]:text-black text-[10px] font-black uppercase tracking-tight h-10 italic">
              <History className="w-3 h-3 mr-2" /> Factory Floor
            </DnaTabsTrigger>
            <DnaTabsTrigger value="finance" className="flex-1 data-[state=active]:bg-white data-[state=active]:text-black text-[10px] font-black uppercase tracking-tight h-10 italic">
              <CreditCard className="w-3 h-3 mr-2" /> Treasury
            </DnaTabsTrigger>
            <DnaTabsTrigger value="warehouse" className="flex-1 data-[state=active]:bg-white data-[state=active]:text-black text-[10px] font-black uppercase tracking-tight h-10 italic">
        ...
        <DnaTabsContent value="marketing" className="mt-0">
          <div className="bg-gray-50 border border-gray-200 rounded-3xl p-1 overflow-hidden">
            <div className="bg-gray-50 p-6 flex items-center justify-between border-b border-gray-200">
              ...
              <DnaButton size="sm" variant="ghost" className="text-zinc-500 hover:text-white group">
        ...
        {/* R&D Department UX */}
        <DnaTabsContent value="rnd" className="mt-0">
          <div className="bg-gray-50 border border-gray-200 rounded-3xl p-1 overflow-hidden">
             <div className="bg-gray-50 p-6 flex items-center justify-between border-b border-gray-200">
              <div>
              ...
              <DnaBadge className="bg-orange-500 text-black font-black italic">INTERLOCK_ACTIVE: 100%_DOSAGE</DnaBadge>
            </div>
            <div className="p-4 bg-gray-50">
              <RndDashboard />
            </div>
        ...
        <DnaTabsContent value="production" className="mt-0">
          <div className="bg-gray-50 border border-gray-200 rounded-3xl p-1 overflow-hidden">
             <div className="bg-gray-50 p-6 flex items-center justify-between border-b border-gray-200">
              <div>
              ...
              <DnaBadge className="bg-emerald-500 text-black font-black italic">LIVE_FEED: WORKSTATION_ALPHA</DnaBadge>
            </div>
            <div className="p-4 bg-gray-50">
              <ProductionFloor />
            </div>
        ...
        <DnaTabsContent value="finance" className="mt-0">
          <div className="bg-gray-50 border border-gray-200 rounded-3xl p-1 overflow-hidden">
             <div className="bg-gray-50 p-6 flex items-center justify-between border-b border-gray-200">
              <div>
              ...
              <DnaBadge className="bg-blue-500 text-white font-black italic">LEDGER_STATION</DnaBadge>
            </div>
            <div className="p-4 bg-gray-50">
              <FinanceDashboard />
            </div>
        ...
        <DnaTabsContent value="warehouse" className="mt-0">
