...
export default function DashboardPage() {
  ...
  return (
    <DashboardShell
      ...
      subtitle="Command Center • Precision Analytics Engine"
      actions={
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-[var(--card-gap)]">
        <div className="bento-card p-[var(--card-px)] bento-card-hover">
          ...
          <div className="space-y-6">
             <div>
                ...
                <div className="row-progress-bg mt-6">
                   <div 
                       className="row-progress-fill bg-primary" 
        ...
        <div className="bento-card p-[var(--card-px)] bento-card-hover border-emerald-100 bg-emerald-50/10">
          <div className="flex justify-between items-center mb-6">
            ...
            <div className="w-10 h-10 rounded-[24px] bg-white flex items-center justify-center text-emerald-500 border border-emerald-100 shadow-sm">
               <TrendingUp className="w-5 h-5" />
            </div>
          </div>
          <div className="space-y-6">
             <div className="flex justify-between items-center bg-white p-4 rounded-[24px] border border-emerald-100 shadow-sm">
                <div>
        ...
        <div className="bento-card p-[var(--card-px)] bento-card-hover">
          ...
          <div className="space-y-6">
             <div>
                ...
                <div className="flex items-center gap-2 mt-4 bg-slate-50 p-3 rounded-[24px] border border-slate-100">
          ...
          <div className="bento-card p-[var(--card-px)] bento-card-hover">
             ...
             <div className="grid grid-cols-2 gap-4">
                {[
                  ...
                  <div key={i} className="bg-slate-50 p-4 rounded-[24px] border border-slate-100 shadow-sm">
