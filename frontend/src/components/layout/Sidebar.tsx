...
const MODULE_STRUCTURE: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Kas Masuk", href: "/finance/cash-in", type: "input" },
      { name: "Kas Keluar", href: "/finance/cash-out", type: "input" },
      { name: "Jurnal Umum", href: "/finance/transactions", type: "history" },
      { name: "COA", href: "/finance/accounting/coa", type: "input" },
      { name: "Auto Journal", href: "/finance/accounting/auto-journal", type: "action" },
      { name: "DP Pembelian", href: "/finance/dp-pembelian", type: "input" },
      { name: "DP Penjualan", href: "/finance/dp-penjualan", type: "input" },
      { name: "Bayar Pembelian", href: "/finance/bayar-pembelian", type: "input" },
      { name: "Bayar Penjualan", href: "/finance/bayar-penjualan", type: "input" },
      { name: "Bayar Sample", href: "/finance/bayar-sample", type: "input" },
      { name: "Faktur Penjualan", href: "/finance/invoices", type: "history" },
      { name: "Faktur Pembelian", href: "/finance/bills", type: "history" },
      { name: "Sales Orders", href: "/finance/sales-orders", type: "action" },
      { name: "AR Validation Hub", href: "/finance/ar-hub", type: "action", badge: "3" },
      { name: "Fund Requests", href: "/finance/fund-requests", type: "input" },
      { name: "Approvals", href: "/finance/approvals", type: "action" },
