...
-- CreateEnum
CREATE TYPE "UserRole" AS ENUM ('SUPER_ADMIN', 'HEAD_OPS', 'COMMERCIAL', 'DIGIMAR', 'RND', 'COMPLIANCE', 'FINANCE', 'PURCHASING', 'PPIC', 'WAREHOUSE', 'PRODUCTION_OP', 'QC_LAB', 'HR', 'IT_SYS', 'ADMIN', 'SCM', 'PRODUCTION', 'MARKETING', 'APJ', 'DIRECTOR');

-- CreateEnum
CREATE TYPE "UserStatus" AS ENUM ('ACTIVE', 'INACTIVE');

-- CreateEnum
CREATE TYPE "LeadStatus" AS ENUM ('PENDING', 'WA_CONTACTED', 'QUALIFIED', 'DISQUALIFIED', 'CONVERTED');

-- CreateEnum
CREATE TYPE "LeadSource" AS ENUM ('INSTAGRAM', 'TIKTOK', 'LINKTREE', 'GOOGLE', 'OFFLINE');

-- CreateEnum
CREATE TYPE "WorkflowStatus" AS ENUM ('NEW_LEAD', 'CONTACTED', 'FOLLOW_UP_1', 'FOLLOW_UP_2', 'FOLLOW_UP_3', 'NEGOTIATION', 'SAMPLE_REQUESTED', 'SAMPLE_SENT', 'SAMPLE_APPROVED', 'SPK_SIGNED', 'WAITING_FINANCE_APPROVAL', 'DP_PAID', 'PRODUCTION_PLAN', 'READY_TO_SHIP', 'WON_DEAL', 'LOST', 'ABORTED');

-- CreateEnum
CREATE TYPE "ActivityType" AS ENUM ('CHAT', 'CALL', 'MEETING_OFFLINE', 'MEETING_ONLINE', 'SAMPLE_PAYMENT', 'DOWN_PAYMENT', 'FINAL_PAYMENT');
...
-- CreateEnum
CREATE TYPE "TrafficSource" AS ENUM ('IG_ADS', 'TIKTOK_ADS', 'FB_ADS', 'GOOGLE_ADS', 'IG_ORGANIC', 'TIKTOK_ORGANIC', 'FB_ORGANIC', 'LINKTREE', 'OTHER');
...
-- CreateEnum
CREATE TYPE "SOStatus" AS ENUM ('PENDING_DP', 'ACTIVE', 'COMPLETED', 'CANCELLED', 'READY_TO_PRODUCE', 'LOCKED_ACTIVE');
...
-- CreateEnum
CREATE TYPE "POStatus" AS ENUM ('DRAFT', 'PENDING_APPROVAL', 'APPROVED', 'ORDERED', 'SHIPPED', 'RECEIVED', 'REJECTED', 'CANCELLED', 'RETURNED');
...
-- CreateEnum
CREATE TYPE "StreamEventType" AS ENUM ('GATE_OPENED', 'GATE_BLOCKED', 'MANUAL_LOG', 'OVERRIDE', 'STATE_CHANGE', 'SLA_BREACH', 'HANDOVER', 'CRITICAL_DELAY', 'HKI_BPOM_REGISTRATION', 'STOCK_CHECK_SHORTAGE', 'STOCK_CHECK_READY');
...
-- CreateEnum
CREATE TYPE "SampleStage" AS ENUM ('WAITING_FINANCE', 'QUEUE', 'FORMULATING', 'LAB_TEST', 'READY_TO_SHIP', 'SHIPPED', 'RECEIVED', 'CLIENT_REVIEW', 'APPROVED', 'REJECTED', 'CANCELLED');
...
-- CreateEnum
CREATE TYPE "FundRequestStatus" AS ENUM ('PENDING_APPROVAL_MGR', 'APPROVED_BY_MGR', 'PENDING_APPROVAL_DIR', 'APPROVED_BY_DIR', 'WAITING_FINANCE_DISBURSEMENT', 'PAID', 'REJECTED');
...
-- CreateEnum
CREATE TYPE "SourceDocumentType" AS ENUM ('SALES_ORDER', 'PURCHASE_ORDER', 'PAYMENT', 'STOCK_ADJUSTMENT', 'SALES_RETURN', 'PURCHASE_RETURN', 'PRODUCTION_PLAN', 'MATERIAL_REQUISITION', 'WORK_ORDER', 'DELIVERY_ORDER');
...
CREATE TABLE "lead_captures" (
    ...
    "kommoLeadId" INTEGER,
    "kommoResponsibleUserId" INTEGER,
    "kommoResponsibleUserName" VARCHAR(255),
    "kommoPipelineId" INTEGER,
    "kommoPipelineName" VARCHAR(255),
    "kommoStatusId" INTEGER,
    "kommoStatusName" VARCHAR(255),
    "kommoSourceName" VARCHAR(255),
    "kommoTags" TEXT,
    "kommoTalkStatus" VARCHAR(50),
    "kommoTalkOrigin" VARCHAR(100),
    "kommoTalkIsRead" BOOLEAN,
    "kommoTalkIsInWork" BOOLEAN,
    "kommoFirstResponseSec" INTEGER,
...
CREATE TABLE "lead_attributes" (
    ...
    CONSTRAINT "lead_attributes_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "round_robin_agents" (
    ...
    CONSTRAINT "round_robin_agents_pkey" PRIMARY KEY ("id")
);
...
-- CreateTable
CREATE TABLE "rnd_weekly_performances" (
    "id" UUID NOT NULL,
    "pic" TEXT NOT NULL,
    ...
    "initiativeScore" DOUBLE PRECISION NOT NULL DEFAULT 0,
    "weeklyScore" DOUBLE PRECISION NOT NULL DEFAULT 0,
    "notes" TEXT,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,

    CONSTRAINT "rnd_weekly_performances_pkey" PRIMARY KEY ("id")
);

-- CreateTable
CREATE TABLE "rnd_failed_trials" (
    "id" UUID NOT NULL,
    "date" DATE NOT NULL,
...
-- CreateTable
CREATE TABLE "rnd_head_trackers" (
    "id" UUID NOT NULL,
    "date" DATE NOT NULL,
    "strategicTask" TEXT,
    "teamSupport" TEXT,
    ...
    CONSTRAINT "rnd_head_trackers_pkey" PRIMARY KEY ("id")
);

-- CreateTable
CREATE TABLE "rnd_monthly_kpis" (
    "id" UUID NOT NULL,
    "month" TEXT NOT NULL,
    "pic" TEXT NOT NULL,
    "ontimePct" DOUBLE PRECISION NOT NULL DEFAULT 0,
    ...
    "initiativeScore" DOUBLE PRECISION NOT NULL DEFAULT 0,
    "knowledgeContribution" DOUBLE PRECISION NOT NULL DEFAULT 0,
    "compositeScore" DOUBLE PRECISION,
    "grade" TEXT,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,

    CONSTRAINT "rnd_monthly_kpis_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "lead_captures_trackingCode_key" ON "lead_captures"("trackingCode");
...
-- CreateIndex
CREATE INDEX "lead_attributes_leadId_idx" ON "lead_attributes"("leadId");

-- CreateIndex
CREATE UNIQUE INDEX "lead_attributes_leadId_key_key" ON "lead_attributes"("leadId", "key");
